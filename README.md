...
- **InfinityFree account** — [https://infinityfree.net/](https://infinityfree.net/)
- Optional local development: **XAMPP** (Apache + MySQL) and **Python 3.8+** for the Flask API
## Prerequisites
- **Node.js 18+** — [Download](https://nodejs.org/)
- **InfinityFree account** — [https://infinityfree.net/](https://www.infinityfree.net/)
- Optional local development: **XAMPP** (Apache + MySQL) and **Python 3.8+** for the Flask API
---
> For full InfinityFree deployment, follow `DEPLOY.md`. The React frontend builds to static files and the PHP backend is served from `/backend`.
